...
class ConvenienceRenderer extends Renderer_1.Renderer {
    ...
    forEachClassProperty(o, blankLocations, f) {
        ...
        if (this._alphabetizeProperties) {
            const alphabetizedPropertyNames = collection_utils_1.mapSortBy(propertyNames, n => Support_1.defined(this.names.get(n)));
            this.forEachWithBlankLines(alphabetizedPropertyNames, blankLocations, (name, jsonName, pos) => {
                const p = Support_1.defined(o.getProperties().get(jsonName));
