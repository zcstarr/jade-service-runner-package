...
class DartTargetLanguage extends TargetLanguage_1.TargetLanguage {
    ...
    getOptions() {
        return [exports.dartOptions.justTypes, exports.dartOptions.codersInClass, exports.dartOptions.methodNamesWithMap];
    }
...
class DartRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    emitClassDefinition(c, className) {
        ...
        this.emitBlock(["class ", className], () => {
            ...
            this.ensureBlankLine();
            this.emitLine("factory ", className, ".from", this._options.methodNamesWithMap ? "Map" : "Json", "(Map<String, dynamic> json) => new ", className, "(");
            this.indent(() => {
    ...
    emitEnumDefinition(e, enumName) {
        ...
        if (this._options.justTypes)
            return;
        this.ensureBlankLine();
        this.emitLine("final ", Support_1.defined(this._enumValues.get(e)), " = new EnumValues({");
        this.indent(() => {
