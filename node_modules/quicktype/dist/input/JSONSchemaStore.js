...
var JSONSchemaStore = /** @class */ (function () {
    function JSONSchemaStore() {
        this._schemas = immutable_1.Map();
    }
    JSONSchemaStore.prototype.add = function (address, schema) {
    ...
    JSONSchemaStore.prototype.get = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var schema;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        schema = this._schemas.get(address);
                        if (schema !== undefined) {
                            return [2 /*return*/, schema];
                        }
                        return [4 /*yield*/, this.fetch(address)];
                    case 1:
                        schema = _a.sent();
                        if (schema === undefined) {
                            return [2 /*return*/, Messages_1.messageError("SchemaCannotFetch", { address: address })];
                        }
